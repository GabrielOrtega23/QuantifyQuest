...
const io = require('socket.io')(http); // Inicializa o Socket.io

// Configurações do Express (exemplo)
...
// Inicia o servidor (linha importante!)
...
const pool = new Pool({
  ...
  ssl: { rejectUnauthorized: false } // Necessário para Render PostgreSQL
});
